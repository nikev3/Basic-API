const passwrd='cfastudentuser'
const { MongoClient, ServerApiVersion } = require('mongodb');
const uri = "mongodb+srv://cfastudentuser:"+passwrd+"@cluster0.nfsnbwr.mongodb.net/?retryWrites=true&w=majority";
...
app.get('/all', async (req, res) => { // <-- Mark the callback function as async
